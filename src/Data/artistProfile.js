...
export const artform =  ["Solo Act", "Band/Group", "Dance Crew", "Theatre/Play", "Comedy", "Magic/Illusion",
...
export const specialization =["Classical Dance Forms", "Traditional Music", "Comedy / stand up comedy", "Traditional Crafts and Handicrafts", "Storytelling", "Folk arts and Culinary Arts", "singing", "dancing", "acting"]

export const performancetype=["Solo Act", "Band/Group", "Dance Crew", "Theatre/Play", "Comedy", "Magic/Illusion", "Circus/Street Performance", "Visual Arts", "Fire/Danger Acts", "Variety Show", "Interactive/Immersive", "Folk/Cultural", "Digital/Technology", "Poetry/Spoken Word", "Performance Art"]
...
export const nameofart=["Bharatanatyam", "Kathak", "Odissi", "Kathakali", "Manipuri", "Mohiniyattam", "Bhangra", "Garba", "Dandiya Raas", "Lavani", "Kuchipudi", "Sattriya", "Chhau", "Giddha", "Yakshagana", "Bihu", "Rauf", "Kalbelia", "Gotipua"
 ...
 export const courses=["Madhubani", "Tanjore", "Warli", "Miniature Painting", "Clay Modeling", "Stone Carving", "Wood Carving", "Bharatanatyam", "Kathak", "Odissi", "Classical Music", "Pottery", "Embroidery", "Weaving", "Block Printing", "Sitar", "Tabla", "Flute", "Veena"
]
export const highestLevelOfPerformance=["International", "National", "State", "District", "Taluka", "Local", "Others"]

export const performanceduration=["½ hour", "1 hour", "1½ hours", "2 hours", "2½ hours", "3 hours", "3½ hours", "4 hours", "4½ hours", "5 hours"]
