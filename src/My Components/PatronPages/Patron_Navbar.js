                ...
                <div>
                    ...
                    {AccountpopupVisible &&
                        <div ref={accountPopupRef} className='Accountpopup' style={{ display: "flex", flexDirection: "column", background: "white", position: "absolute", width: "297px", marginLeft: "-170px", borderRadius: "10px" }} >
                            <Link to={"/Patron_Profile"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Profile</Link>
                            ...
                            <Link to={"/contactUs"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Contact Us</Link>
                            <Link to={"/latestNews"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Latest News</Link>
