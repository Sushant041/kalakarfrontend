...
const profileData = [
  {
    id: 1,
    name: "Mano Selva Vijay",
    profession: "Dancer",
    image: "assets/Newsletter/Profile.png",
    email: "randomemail@gmail.com",
    phone: "1234568901",
    address: "123 random street, random city - 123456",
                  ...
                  <div className="ArtistProfiles_ProfileCard">
                    <div className="ArtistProfiles_ProfileCard_left">
                      ...
                      <div className="ArtistProfiles_ProfileCard_left_components">
                        ...
                        <p>
                          {" "}
                          &nbsp; {profile.address} <br></br> &nbsp; {profile.district}
                          <br></br> &nbsp; {profile.state}
                        </p>
                      </div>
                      <div className="ArtistProfiles_ProfileCard_left_components_social">
                        <div className="insta">
                          <p>
