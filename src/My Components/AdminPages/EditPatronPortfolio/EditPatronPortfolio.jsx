...
import "../../PatronPages/PatronProfile/Portfolio/Edit_Patron_Portfolio.css";
import Footer from "../../Footer/Footer";


export default function EditPatronPortfolio() {
                ...
                <div className='EditPatronPortfolio_form'>
                    <form>
                        <div className='EditPatronPortfolio_form_input'>
                            ...
                            <input placeholder='Enter the name for card' value=""name='firstName'  ></input>
                        </div>
                        <div className='EditPatronPortfolio_form_input'>
                            <label>Profession</label>
                            <input placeholder='Enter your performance category' value="" name='natureOfArt' ></input>
                        </div>
                        <div className='EditPatronPortfolio_form_input'>
                            <label>Contact Number</label>
                            <input placeholder='Enter your mobile number' value=""name='phoneNumber' ></input>
                        </div>
                        <div className='EditPatronPortfolio_form_input'>
                            <label>Email Id</label>
                            <input placeholder='Enter your email address' value="" name='email' ></input>
                        </div>
                        <div className='EditPatronPortfolio_form_input'>
                            <label>Location</label>
                            <input placeholder='Enter your location' value="" name='address' ></input>
                        </div>
                        <div className='EditPatronPortfolio_form_input'>
                            <label>Full Name</label>
                            <input placeholder='Enter your location' value="" name='fullName' ></input>
                        </div>
                        <div className='EditPatronPortfolio_form_input'>
                            <label>About the Company</label>
                            <textarea placeholder='Enter about your comapny' value="" name='about' ></textarea>
                        </div>
