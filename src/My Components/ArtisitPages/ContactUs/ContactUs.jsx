...
const formDetail = [
  ...
  },
  {
    ...
    type: "text",
    name: "countryCode", // Updated name for country code field
  },
  {
    placeholder: "Enter your contact number",
    type: "text",
    name: "phoneNumber", // Updated name for phone number field
  },
];
...
const ContactUs = () => {
  ...
  const fetchUserData = async()=>{
    try{
      ...
      setFormData({
        ...formData,
        phoneNumber: personalInfo?.contactNumber?.number || "", // Set phoneNumber as a string
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    message: "",
    countryCode: "", // Updated initial state for country code
    phoneNumber: "", // Updated initial state for phone number
    subject: "",
  });
