                ...
                <div className='OpportunitiesMoreInfoPage_Topbox'>
                    ...
                    <div className='OpportunitiesMoreInfoPage_Topboxcontent'>
                        <div className="OpportunitiesPage_displayonejob_contentdetailsone">
                            <p>Category :&emsp;<span>{job.role}</span></p>
                            <p>Posted on :&emsp;<span>{new Date(job.applicationPeriod.start).toLocaleDateString("en-US", {day: "numeric",month: "short", year: "numeric",
                                               })}</span></p>
                            <p>Due Date :&emsp; <span>{new Date(job.applicationPeriod.end).toLocaleDateString("en-US", {day: "numeric",month: "short", year: "numeric",
                                               })}</span></p>
                            <p> Opening :&emsp;  <span>{job.openings}</span></p>
                        </div>
                ...
                <div className='OpportunitiesMoreInfoPage_bottombox'>
                    ...
                    <div className="OpportunitiesMoreInfoPage_bottombox_RSO">
                        ...
                        <div>
                            ...
                            <p><span>{job.budget}</span></p>
                            <p><span>{job.theme}</span></p>
                            <p><span>{job.timeSlot}</span></p>
                            <p><span>{job.performanceDuration}</span></p>
                            <p><span>{job.artNature}</span></p>
                            <p><span>{job.performanceType}</span></p>
                            <p><span>{job.mediaType}</span></p>
                            <p><span>{job.artLevel}</span></p>
                            <p><span>{job.location}</span></p>
