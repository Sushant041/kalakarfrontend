...
export function Artist_Opportunities() {
    ...
    const [OpportunityapplynowPopup, setOpportunityapplynowPopup] = useState(false);
                ...
                <div className="">
                    <form className="OpportunitiesPage_SearchSort">
                        ...
                        <div className="OpportunitiesPage_Sort">
                            ...
                            <button type="button" onClick={() => setShowOpportunityFiltersPopup(true)}>Filters</button>
                        </div>
                    </form>
                    <div>
                                ...
                                <div className="OpportunitiesPage_displayonejob_contentdetailsone">
                                    <div className="OpportunitiesPage_displayonejob_contentdetailsone_text">
                                        ...
                                        <div className="OpportunitiesPage_displayonejob_contentdetailstwo">
                                            <p>{job.location}</p>
                                            <p>{job.dateOfPerformance}</p>
                                            <p>{job.amount}</p>
                                            <p>{job.language}</p>
                                            <p>{job.applicationDueDate}</p>
                                        </div>
                                    </div>
                                </div>

                                <div className="OpportunitiesPage_displayonejob_contentdetailsbuttons">
                                    <button className="btnone"> <Link to={`/Artist_OpportunityDetails`}
                                        state={{ job: jobData[index] }} // Pass the data of the clicked job
                                        style={{ textDecoration: "none", color: "#ad2f3b" }} >More Information</Link></button>
                                    <button className="btntwo" onClick={() => setOpportunityapplynowPopup(index)}>Apply Now</button>
                                </div>

                                <div>
                                    {OpportunityapplynowPopup === index && (
