            ...
            <div>
              ...
              {AccountpopupVisible &&
                <div ref={accountPopupRef} className='Accountpopup' style={{ display: "flex", flexDirection: "column", background: "white", position: "absolute", width: "297px", marginLeft: "-170px", borderRadius: "10px" }} >
                  <Link to={"/Artist_Profile"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Profile</Link>
                  <Link style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Dashboard</Link>
                  <Link to={"/Artist_Opportunities"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Opportunities</Link>
                  <Link to={"/statusOfApplication"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Status of Application</Link>
                  <Link style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Skill Development</Link>
                  <Link to={"/Newsletter"} style={{ height: "48px", boxShadow: " 0px 1px 10px 2px rgba(0, 0, 0, 0.12)", textDecoration: "none", color: "black", display: "flex", alignItems: "center", padding: "20px" }}>Latest News</Link>
          ...
          <form onSubmit={artSubmitHandler}>
            ...
            <div className="ArtProfile_ArtInfo">
              <div className="ArtProfile_inputfield">
                ...
                >
                  <option selected hidden>Select nature</option>
              ...
              <div className="ArtProfile_inputfield">
                ...
                >
                  ...
                  <option>Solo Act</option>
                  <option>Band/Group</option>
                  <option>Dance Crew</option>
                  <option>Theatre/Play</option>
                  <option>Comedy</option>
                  <option>Magic/Illusion</option>
                  <option>Circus/Street Performance</option>
                  <option>Visual Arts</option>
                  <option>Fire/Danger Acts</option>
                  <option>Variety Show</option>
                  <option>Interactive/Immersive</option>
                  <option>Folk/Cultural</option>
              ...
              <div className="ArtProfile_Professional">
                ...
                <div className="ArtProfile_inputfield">
                  ...
                  >
                    ...
                    <option>Classical Dance Forms</option>
                    <option>Traditional Music</option>
                    <option>Comedy / stand up comedy</option>
                    <option>Traditional Crafts and Handicrafts</option>
                    <option>Storytelling</option>
                    <option>Folk arts and Culinary Arts, singing</option>
                  </select>
                </div>
                <div className="ArtProfile_inputfield">
            ...
            <div className="PerformanceProfile_PerformInfo">
              ...
              <div className="PerformanceProfile_inputfield">
                ...
                >
                  ...
                  <option>Rs 35000</option>
                  <option>Rs 40000</option>
                  <option>Rs 45000</option>
