...
//     try {
//       const response = await fetch("http://localhost:4000/api/v1/admin/user?role=Artist", {
//         method: "GET",
//         headers: {
//           'Authorization': `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTQwODJjYzU1NzBkODY1NjA2NGVmNjciLCJpYXQiOjE3MDMwNzU0ODEsImV4cCI6MTcwMzE2MTg4MX0.zm0CNvvJKRhEhX3T-hUeoW3p1juFEf3DhDNKKdGOpUU`,
...
//            <td className="block" onClick={(e)=>{toggleblock(e)}}>Unblock</td>
//            <td className="approve" onClick={(e)=>{toggleapproved(e)}}>Approved</td>
//            <td className="verify" onClick={(e)=>{toggleverify(e)}}>Verified</td>
...
//   useEffect(() => {
//     const route = "http://localhost:4000/api/v1/admin/user?role=Artist";
//     const authRoute = "http://localhost:4000/api/v1/auth";
...
//           },
//           body: JSON.stringify({ /* Add login details if needed */ }),
//         });
...
//     try {
//       const refreshResponse = await fetch(/* Refresh token endpoint */, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//           await refreshToken();
//           return fetchData(); // Retry fetching data after token refresh
//         } else {
...
// const [data,setdata]=useState([])
// const route="http://localhost:4000/api/v1/admin/user?role=Artist"
// const GetArtist = async (route ,token) =>
//   { 
